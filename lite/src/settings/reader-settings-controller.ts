...
const panels = [
	...
	},
	{
		...
		groupId: 'system-data',
		title: '性能设置',
		description: '设置每批加载、页面保留、预加载和请求节奏的目标上限；运行时会按设备、网络与限流自适应下调，保存后当前与后续帖子立即生效。',
	...
	},
	{
		...
		groupId: 'system-data',
		title: '日志记录',
		description: '请求记录显示生效车道、优先级、升级复用、取消和 429；性能记录显示自适应后的运行策略、DOM、内存与主线程事件。所有记录仅保留在当前页面内存中，不保存查询参数、请求正文、Cookie、响应内容或个人数据。',
