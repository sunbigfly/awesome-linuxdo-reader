...
> `1.6.6` 已完成 GitHub、Greasy Fork 四文件链和用户手册同步；本节记录当前不可变坐标与逐字节核验结果。
...
| --- | --- | --- | --- |
| 主 Loader | [588185](https://greasyfork.org/scripts/588185) | `1931401` | 固定文件 4,173 字节，SHA-256 `904d6f3c5e7b5abe75db12e018f4a61a8cd5da250892041035387078855331e2`；移除平台加入的 `@downloadURL none` 后为 4,152 字节，SHA-256 `1fae88a9a99465c48abeb59d49d43d5c405f9a39409157e66d4a6398b5ccf78d` |
| Core | [590254](https://greasyfork.org/scripts/590254) | `1931396` | 1,740,789 字节，SHA-256 `e7ac617450f592f9001dbdf3dcc506041ac99efb5590d1f32526d4a6ccaf51b6` |
| Platform | [591595](https://greasyfork.org/scripts/591595) | `1931398` | 1,491,680 字节，SHA-256 `d302dee8fa9f58bc84ab897c476be7deaa5ab660ed900ea0f9eeb580d1ffadf4` |
| Features | [590255](https://greasyfork.org/scripts/590255) | `1931397` | 2,022,114 字节，SHA-256 `feb27200aec1846ad496858b2fa877cd8335ce7eeab74bee5cb53d5da19eec1b` |

四个发布单元已在 `update.greasyfork.org` 固定版本 URL 核验；主 Loader 归一化后与仓库产物逐字节一致。CSS 未变化，继续固定到 Git `4473716d05c9151c79639d6a17e4d71e124c7aef`，696,558 字节，SHA-256 `7cf3e876b3536c0d2f23325fe3fe88c7152c1c632f09c2622309c0799a8bd68c`。

### v1.6.5 已发布坐标

| 发布单元 | Greasy Fork | 固定版本 | 核验结果 |
| --- | --- | --- | --- |
| 主 Loader | [588185](https://greasyfork.org/scripts/588185) | `1929091` | 固定文件 4,173 字节，SHA-256 `3438c88899e65e5243a77bf62c20d7e037d0eda35ded1e2846e3a3c77477d210`；移除平台加入的 `@downloadURL none` 后为 4,152 字节，SHA-256 `bf0ec28e250784e9c976379e7df9405465f9004086b35d3210cb31cf9d97dfb9` |
| Core | [590254](https://greasyfork.org/scripts/590254) | `1929088` | 1,740,611 字节，SHA-256 `f4a1f29f1c4c9e5f23acb3455bcc936f676eec2012e0069d395372ad613331f4` |
| Platform | [591595](https://greasyfork.org/scripts/591595) | `1929090` | 1,491,587 字节，SHA-256 `6114c3882645348c8453fd15bba5a2aa70241a9d88f05b73704090ff15ade8c6` |
| Features | [590255](https://greasyfork.org/scripts/590255) | `1929089` | 2,022,114 字节，SHA-256 `f36367beee9d7e92551860d70a1c6c606b9efd174e6f03157ff82a0a4d7ad760` |
...
| 发布单元 | Greasy Fork | 固定版本 | 核验结果 |
| --- | --- | --- | --- |
| 主 Loader | [588185](https://greasyfork.org/scripts/588185) | `1921699` | 固定文件 4,173 字节，SHA-256 `7b68003bd806ec1c2b0b681aee3c2b9002045c0cdcf3f6d15b1785d35c8a6de5`；移除平台加入的 `@downloadURL none` 后为 4,152 字节，SHA-256 `f9248c55c2ab1fc86c43b028063ed0cae621afc814f3dd7fd72aaa7f95233c7f` |
| Core | [590254](https://greasyfork.org/scripts/590254) | `1921693` | 1,739,322 字节，SHA-256 `aec251cdb2502211bf4add0e8abfa6d7449ecd1abcf816f89f0165d2853a5288` |
| Platform | [591595](https://greasyfork.org/scripts/591595) | `1921695` | 1,491,573 字节，SHA-256 `09b9ab7e8c567fb5645976254b61681c9f5eac01866bd514c0e95cdd7397992b` |
| Features | [590255](https://greasyfork.org/scripts/590255) | `1921694` | 2,022,100 字节，SHA-256 `734fc340bf5f3d08340217f8de649b1352035f7595acca1629dd2e6949266271` |
...
| 发布单元 | Greasy Fork | 固定版本 | 核验结果 |
| --- | --- | --- | --- |
| 主 Loader | [588185](https://greasyfork.org/scripts/588185) | `1914298` | 固定文件 4,173 字节，SHA-256 `c518455262e0a811be49ed686906eab03f7279979128e9badbef492ead85a01a`；移除平台加入的 `@downloadURL none` 后为 4,152 字节，SHA-256 `5e35a981598c18cfe1d7e4dccdb0b7e1d53d7b56b59a7f84ae2efe7171c95f04` |
| Core | [590254](https://greasyfork.org/scripts/590254) | `1914292` | 1,739,322 字节，SHA-256 `0b1ab733f3891bf39e3e4bfb28bc486eb85317edd73e5d658c402c2621a18fe9` |
| Platform | [591595](https://greasyfork.org/scripts/591595) | `1914294` | 1,491,039 字节，SHA-256 `19e3c5bcc93772dd779f06957eeaa83ff5d0b69381ea956ae715661411fbd014` |
| Features | [590255](https://greasyfork.org/scripts/590255) | `1914293` | 2,022,100 字节，SHA-256 `21325b267ed42e07ca0f50a64989e57bc3dcc96cac53c91ebdc72c015b57e6a8` |
...
| 发布单元 | Greasy Fork | 固定版本 | 核验结果 |
| --- | --- | --- | --- |
| 主 Loader | [588185](https://greasyfork.org/scripts/588185) | `1910580` | 固定文件 4,202 字节，SHA-256 `ad86d37a6eda6e922289319cfc5f49c41760c89c87e62c8272b43e318574886a`；移除平台加入的 `@downloadURL none` 后为 4,181 字节，SHA-256 `5dfd86c76883c603e36bd350005cb657fe5e27e209fadcdbc53ec7f492618377` |
| Core | [590254](https://greasyfork.org/scripts/590254) | `1910575` | 1,738,833 字节，SHA-256 `bfec60620a453ffde822fbb18fff2b840592cefdcbf8d27a3c638b5d35743454` |
| Platform | [591595](https://greasyfork.org/scripts/591595) | `1910577` | 1,490,614 字节，SHA-256 `b1bf5294baca37df8ad5ffb9396ccd4ed241033258e0ed1b58dfbba383288bae` |
| Features | [590255](https://greasyfork.org/scripts/590255) | `1910576` | 2,020,439 字节，SHA-256 `b3e6c891249eff335c932b9f14de5f6752b8f02a2cc67c3e0ae33c1c0f52d07d` |

四个发布单元已在 `update.greasyfork.org` 固定版本 URL 核验；主 Loader 归一化后与仓库产物逐字节一致。CSS 固定到 Git `4473716d05c9151c79639d6a17e4d71e124c7aef`，696,558 字节，SHA-256 `7cf3e876b3536c0d2f23325fe3fe88c7152c1c632f09c2622309c0799a8bd68c`。

### v1.6.1 已发布坐标

| 发布单元 | Greasy Fork | 固定版本 | 核验结果 |
| --- | --- | --- | --- |
| 主 Loader | [588185](https://greasyfork.org/scripts/588185) | `1909752` | 固定文件 4,202 字节，SHA-256 `c3322f51e8facfd201e31775675a7d66651a2eb9d2fc7d014c8064c719447aa6`；移除平台加入的 `@downloadURL none` 后为 4,181 字节，SHA-256 `d6a6630a583d940ab8f5b302b99108edc746ed5ec8bd82c0151faacf2a609395` |
| Core | [590254](https://greasyfork.org/scripts/590254) | `1909749` | 1,730,972 字节，SHA-256 `5b71ab3be91ae5b966c3b0c95140d3bd012759cb03b06740fdd00a4780f0c544` |
| Platform | [591595](https://greasyfork.org/scripts/591595) | `1909731` | 1,482,147 字节，SHA-256 `f3fc41247dd79a34e9420af92d8a23fc644c4b20309269d3f0dae947a67aa033` |
| Features | [590255](https://greasyfork.org/scripts/590255) | `1909750` | 1,993,857 字节，SHA-256 `2548c22f4323304e34529ecc4a242cbe46c0368e1c0b602b1e4563d176c58509` |

四个发布单元已在 `update.greasyfork.org` 固定版本 URL 核验；主 Loader 归一化后与仓库产物逐字节一致。CSS 固定到 Git `36ca6edefacac79bdaa3243932000671eba1d14e`，688,457 字节，SHA-256 `93e59f079e926511f6c8539e2496646791955cef01d8f70e144a0dbecc27258b`。Platform 字节未变化，因此继续复用同版本已核验坐标。
...
| 发布单元 | Greasy Fork | 固定版本 | 核验结果 |
| --- | --- | --- | --- |
| 主 Loader | [588185](https://greasyfork.org/scripts/588185) | `1908857` | 固定文件 4,174 字节，SHA-256 `6f99f0b42ec7c897c5b60b1e152b376a65667ecb948bbcd5ed01520b6ac1164f`；移除平台加入的 `@downloadURL none` 后为 4,153 字节，SHA-256 `306d95ab39e0724c87175115255e19e5a70b5a42184d378f83482e8d7df42c59` |
| Core | [590254](https://greasyfork.org/scripts/590254) | `1908854` | 1,670,656 字节，SHA-256 `50233764e589986904b8ff672a62d397a24bcdfc5fb2f4b5dd57e2286ec96b15` |
| Platform | [591595](https://greasyfork.org/scripts/591595) | `1908856` | 1,344,488 字节，SHA-256 `aff265e0cf41f44681da9a96145797e668159e28ae5519b687d2f730f97e6101` |
| Features | [590255](https://greasyfork.org/scripts/590255) | `1908855` | 2,096,052 字节，SHA-256 `99281d3a1c8e23fac471e20fc9b604cfe6f4e7e971d1ab32f4d619e2f848f98f` |

四个发布单元已在 `update.greasyfork.org` 固定版本 URL 核验；主 Loader 归一化后与仓库产物逐字节一致。CSS 没有变化，继续固定到 Git `1c40185f28a0c2493c498da2898178b16b648e82`，622,157 字节，SHA-256 `99ffa9100f6dba1dea3a5fe8e4a273a07fa14eb5d791340914a14afccc4812f9`。
...
四个发布单元已在 `update.greasyfork.org` 固定版本 URL 核验；主 Loader 归一化后与仓库产物逐字节一致。CSS 固定到 Git `1c40185f28a0c2493c498da2898178b16b648e82`，622,157 字节，SHA-256 `99ffa9100f6dba1dea3a5fe8e4a273a07fa14eb5d791340914a14afccc4812f9`。
