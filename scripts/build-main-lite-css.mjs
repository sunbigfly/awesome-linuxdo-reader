...
const artifact = [
	...
	' * Generated only from lite/styles/*.css; do not edit generated outputs.',
...
if (checkOnly) {
	for (const outputPath of outputPaths) {
		...
		if (current !== artifact) {
			throw new Error(
				`${path.relative(projectRoot, outputPath)} 缺失或已过期，` +
				'请运行 npm run main-lite:css:build',
			);
		}
	}
} else {
...
process.stdout.write(`${JSON.stringify({
	...
	output: 'work/main-lite.css',
	compatibilityOutputs: ['work/mian-lite.css'],
