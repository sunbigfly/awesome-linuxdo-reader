...
> 当前正式版为 Lite `1.5.4`。发布坐标：Loader `588185 / 1905015`、Core `590254 / 1905010`、Platform `591595 / 1905012`、Features `590255 / 1905011`。更新后刷新已打开的 Discourse 页面，并在“设置 → 关于”或脚本管理器中核对实际运行版本。
