...
> 当前正式版为 Lite `1.6.6`。发布坐标：Loader `588185 / 1931401`、Core `590254 / 1931396`、Platform `591595 / 1931398`、Features `590255 / 1931397`。本版修复已添加书签的话题标题重复，以及阅读队列、免打扰按钮的位置错乱。更新后完整刷新已打开的 Discourse 页面，在“设置 → 关于”或脚本管理器中核对实际运行版本。
