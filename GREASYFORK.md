...
> 当前正式版为 Lite `1.6.4`。发布坐标：Loader `588185 / 1921699`、Core `590254 / 1921693`、Platform `591595 / 1921695`、Features `590255 / 1921694`。本版修复 Boost `@` 回复入口，使引用正文和目标楼层随原生 Composer 一起建立。Loader 默认只在 21 个内置社区运行；其他标准 Discourse 需先由脚本管理器允许当前域名，识别成功后会询问是否保存为自定义站点。更新后刷新已打开的 Discourse 页面，并在“设置 → 关于”或脚本管理器中核对实际运行版本。
