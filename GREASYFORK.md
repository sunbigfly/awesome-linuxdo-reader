...
> 当前正式版为 Lite `1.6.5`。发布坐标：Loader `588185 / 1929091`、Core `590254 / 1929088`、Platform `591595 / 1929090`、Features `590255 / 1929089`。本版修复移动端启动参数和局部 GM 接口捕获，并阻止失败入口重复初始化。更新后完整刷新已打开的 Discourse 页面，在“设置 → 关于”或脚本管理器中核对实际运行版本。
