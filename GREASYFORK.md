...
> 当前正式版为 Lite `1.5.5`。发布坐标：Loader `588185 / 1905077`、Core `590254 / 1905073`、Platform `591595 / 1905075`、Features `590255 / 1905074`。更新后刷新已打开的 Discourse 页面，并在“设置 → 关于”或脚本管理器中核对实际运行版本。
