...
> 当前正式版为 Lite `1.5.1`。发布坐标：Loader `588185 / 1904337`、Core `590254 / 1904332`、Platform `591595 / 1904334`、Features `590255 / 1904333`。更新后刷新已打开的 Discourse 页面，并在“设置 → 关于”或脚本管理器中核对实际运行版本。
