...
![三种配置形态和五区比例设置](/screenshots/guide-05-layout-settings-v1.0.0.png)
...
![多主题阅读队列中的当前项、固定状态和后台准备进度](/screenshots/guide-21-reading-queue-v1.0.0.png)
...
![主楼层批量、DOM 窗口和挂载上限设置](/screenshots/guide-09-performance-settings-v1.0.0.png)
