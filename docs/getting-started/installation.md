...
::: tip 当前发布状态
Lite `1.2.5` 已发布到 Greasy Fork。脚本 588185 的主 Loader 固定版本为 `1897778`，加载 Core `1897774` 和 Features `1897776`；三文件与 CSS 固定坐标、字节数和 SHA-256 均已核验。
:::
...
- 在“设置 → 关于”或脚本管理器中确认版本；本手册当前对应 `1.2.5`，正式线上版当前也对应 `1.2.5`。
