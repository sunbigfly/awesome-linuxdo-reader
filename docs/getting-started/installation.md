...
::: tip 当前发布状态
Lite `1.2.3` 已发布到 Greasy Fork。脚本 588185 的主 Loader 固定版本为 `1897714`，加载 Core `1897707` 和 Features `1897709`；三文件固定坐标、字节数和 SHA-256 均已核验。
:::
...
- 在“设置 → 关于”或脚本管理器中确认版本；本手册当前对应 `1.2.4`。
