      ...
      '/settings/': [
        {
          ...
          items: [
            ...
            { text: '09 · 帖子与回复', link: '/settings/other#主帖操作列' },
            { text: '10 · 适用站点', link: '/settings/other#其他适用站点' },
            { text: '11 · 性能设置', link: '/settings/performance' },
            { text: '12 · 日志记录', link: '/settings/request-data' },
            { text: '13 · 数据管理', link: '/settings/data-management' },
            { text: '14 · 关于', link: '/settings/about' },
          ],
        },
        {
          text: '专题与参考',
