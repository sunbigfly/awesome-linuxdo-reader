      ...
      '/settings/': [
        {
          ...
          items: [
            ...
            { text: '10 · 快捷方式', link: '/settings/other#快捷方式' },
            { text: '11 · 帖子与回复', link: '/settings/other#主帖操作列' },
            { text: '12 · 适用站点', link: '/settings/other#其他适用站点' },
            { text: '13 · 性能设置', link: '/settings/performance' },
            { text: '14 · 日志记录', link: '/settings/request-data' },
            { text: '15 · 数据管理', link: '/settings/data-management' },
            { text: '16 · WebDAV 同步', link: '/settings/webdav-sync' },
            { text: '17 · 关于', link: '/settings/about' },
          ],
        },
        {
          text: '专题与参考',
