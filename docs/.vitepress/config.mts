      ...
      '/settings/': [
        {
          ...
          items: [
            ...
            { text: '07 · 动画与提示', link: '/settings/motion' },
            { text: '08 · 阅读与导航', link: '/settings/other' },
            { text: '09 · 翻译设置', link: '/guide/content-and-media#跨语正文翻译' },
            { text: '10 · AI 服务', link: '/settings/reference#ai-服务' },
            { text: '11 · 快捷方式', link: '/settings/other#快捷方式' },
            { text: '12 · 帖子与回复', link: '/settings/other#主帖操作列' },
            { text: '13 · 适用站点', link: '/settings/other#其他适用站点' },
            { text: '14 · 性能设置', link: '/settings/performance' },
            { text: '15 · 日志记录', link: '/settings/request-data' },
            { text: '16 · 数据管理', link: '/settings/data-management' },
            { text: '17 · WebDAV 同步', link: '/settings/webdav-sync' },
            { text: '18 · 关于', link: '/settings/about' },
          ],
        },
        {
          text: '专题与参考',
          items: [
            ...
            { text: '性能记录明细', link: '/settings/resource-monitor' },
